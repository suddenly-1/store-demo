//  scroll
// 下拉
export const PULL_DOWN_HEIGHT = 80
...
export const PULL_UP_TEXT_INIT = '再拉，再拉就刷给你看'
export const PULL_UP_TEXT_START = '够了啦，松开人家嘛'
export const PULL_UP_TEXT_ING = '刷呀刷呀，好累啊，喵^ω^'
export const PULL_UP_TEXT_END = '刷新完了哦'
